        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-gray-800/40 rounded-2xl p-6 md:p-8 border border-gray-700/50 hover:border-purple-500/50 shadow-none hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] text-center flex flex-col h-auto md:h-80"
            >
